...
<div class="container mt-4">
    ...
    <form method="POST" action="" class="mt-3" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="location_lat" name="location_lat" step="any" placeholder="e.g., -1.2921">
        </div>
        <div class="form-group">
            <label for="location_lng">Longitude</label>
            <input type="number" class="form-control" id="location_lng" name="location_lng" step="any" placeholder="e.g., 36.8219">
        </div>
